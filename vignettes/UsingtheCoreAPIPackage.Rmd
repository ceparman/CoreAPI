...
Values for the first three parameters and required and the account entry is only required if the user has access to more than one tenant. If the account parmeter is not required pas a zero length string "" . This function return an object which contains the information in the json and a valid jsession ID in the list object named CoreApi.
