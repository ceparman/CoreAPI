...
#'
#'@param coreUrl base url of LIMS
#'@param jsessionid jsessionid to log out of username
...
### Log out
#
logOut<-function(coreUrl, jsessionid, useVerbose = FALSE)

{

  log_out_url<-paste(coreUrl,"/sdklogin",";jsessionid=",jsessionid,sep="")
